...
<style id="d9o-nav-activation">
  
</style>

<%def name="activation_no_nav_link()">
<%doc>
  CSS for use on pages excluded from the main navigation.
  - ensures that no nav-link has a background image.
</%doc>
    .site-nav ul li a {
